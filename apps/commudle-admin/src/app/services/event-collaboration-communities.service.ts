...
export class EventCollaborationCommunitiesService {
  ...
  get(eventId): Observable<IEventCollaborationCommunities> {
    ...
    return this.http.get<IEventCollaborationCommunities>(
      this.apiRoutesService.getRoute(API_ROUTES.EVENT_COLLABORATION_COMMUNITIES.INDEX),
      { params },
    );
  }
  ...
  destroy(eventCollaborationCommunityId): Observable<any> {
    const params = new HttpParams().set('event_collaboration_community_id', eventCollaborationCommunityId);
    return this.http.delete<any>(this.apiRoutesService.getRoute(API_ROUTES.EVENT_COLLABORATION_COMMUNITIES.DELETE), {
      params,
    });
  }
  ...
  resendInvitationMail(eventCollaborationCommunityId) {
    ...
    return this.http.get<any>(
      this.apiRoutesService.getRoute(API_ROUTES.EVENT_COLLABORATION_COMMUNITIES.RESEND_INVITATION),
      { params },
    );
  }

  confirmCollaboration(token): Observable<any> {
    return this.http.put<any>(this.apiRoutesService.getRoute(API_ROUTES.EVENT_COLLABORATION_COMMUNITIES.CONFIRM), {
      token,
    });
  }
  ...
  pGet(eventId): Observable<IEventCollaborationCommunities> {
    const params = new HttpParams().set('event_id', eventId);
    return this.http.get<IEventCollaborationCommunities>(
      this.apiRoutesService.getRoute(API_ROUTES.EVENT_COLLABORATION_COMMUNITIES.PUBLIC_INDEX),
      { params },
    );
  }
}
